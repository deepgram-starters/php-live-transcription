# php-live-transcription

PHP demo app for Deepgram Live Transcription.
...
```
feat(php-live-transcription): add diarization support
fix(php-live-transcription): resolve WebSocket close handling
refactor(php-live-transcription): simplify session endpoint
