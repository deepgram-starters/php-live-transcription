# PHP Live Transcription Makefile
...
help:
	@echo "PHP Live Transcription - Available Commands"
	@echo "============================================"
	@echo ""
	@echo "Setup:"
...
check-prereqs:
	...
	@command -v php >/dev/null 2>&1 || { echo "php is required but not installed. Visit https://www.php.net/downloads"; exit 1; }
	@command -v composer >/dev/null 2>&1 || { echo "composer is required but not installed. Visit https://getcomposer.org/download/"; exit 1; }
